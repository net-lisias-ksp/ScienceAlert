...
namespace ScienceAlertTests.VesselContext.Experiments
{
    public class ExperimentReportValueCalculatorTests
    {
            ...
            Fixture fixture)
        {
            ...
            var vessel = MockVessel(experiment, experimentSituation, 5, 5, onboardReportCount, 0, subject, 0.5f, EmptyLabIds);
            ...
            Fixture fixture)
        {
            ...
            var vessel = MockVessel(experiment, experimentSituation, 5, 5, onboardReportCount, 0, subject, xmitMultiplier, EmptyLabIds);
            ...
            Fixture fixture)
        {
            ...
            var vessel = MockVessel(experiment, situation, 5, 5, 0, 1, subject, 1f, EmptyLabIds);
            ...
            Fixture fixture)
        {
            ...
            var vessel = MockVessel(experiment, situation, 5, 5, 0, 0, subject, 1f, EmptyLabIds);
            ...
            Fixture fixture)
        {
            ...
            var vessel = MockVessel(experiment, situation, 5, 5, 0, 1, subject, 1f, analyzedIds);
            ...
            Fixture fixture)
        {
            ...
            var vessel = MockVessel(experiment, situation, 5, 5, 0, 2, subject, 1f, otherIds);
