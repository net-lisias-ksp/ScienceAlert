...
[LOG 07:11:30.108] spaceAltitudeThreshold: 60000
         * */
        public static class ScienceSubjectFactory
        {
            private static readonly Dictionary<string, CelestialBodyScienceParams> _celestialBodyScienceParams =
            ...
            public static IScienceSubject Create(ScienceExperiment experiment, string bodyName, ExperimentSituations situation, string subjectId, float alreadyCollectedScience)
            {
                ...
                if (!_celestialBodyScienceParams.TryGetValue(bodyName, out bodyParams))
        ...
        public static class ScienceExperimentFactory
        {
            ...
            private static Dictionary<string, ScienceExperiment> _scienceExperiments = new Dictionary
            ...
            public static ScienceExperiment Create(string name)
            {
                ...
                if (!_scienceExperiments.TryGetValue(name, out result))
