...
//{
//    internal class CommandConfigureTriggerBuilders : CommandConfigureObjectFromConfigNodeBuilders<ITriggerBuilder>
//    {
//        public CommandConfigureTriggerBuilders(ITemporaryBindingFactory temporaryBinder, ObjectFromConfigNodeBuilderTypeQueries typeQueries) : base(temporaryBinder, typeQueries)
//        {
//        }
...
//    internal class CommandConfigureRuleBuilders : CommandConfigureObjectFromConfigNodeBuilders<IRuleBuilder>
//    {
//        public CommandConfigureRuleBuilders(ITemporaryBindingFactory temporaryBinder, ObjectFromConfigNodeBuilderTypeQueries typeQueries) : base(temporaryBinder, typeQueries)
//        {
//        }

//        private IExperimentRule CreateLogicalRule(
...
//            var subRules = subNodes.Select(n => allBuilders.Build(n, allBuilders, injectionBinder, bindingFactory)).ToArray();
