...
//{
//    // Creates a ExperimentConfiguration given a ConfigNode that matches "SA_SENSOR_DEFINITION"
//    class SensorDefinitionBuilder : IConfigNodeObjectBuilder<ExperimentConfiguration>, ISensorDefinitionFactory
//    {
...
//        public ExperimentConfiguration Build(ConfigNode config)
//        {
//            if (!CanHandle(config))
...
//        public ExperimentConfiguration CreateDefault(ScienceExperiment experiment)
//        {
//            return new ExperimentConfiguration(
//                experiment, 
