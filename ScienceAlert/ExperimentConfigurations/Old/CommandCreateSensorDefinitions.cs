...
//        private readonly IConfigNodeObjectBuilder<ExperimentConfiguration> _sensorDefinitionBuilder;
...
//            IConfigNodeObjectBuilder<ExperimentConfiguration> sensorDefinitionBuilder,
...
//            injectionBinder
//                .Bind<ReadOnlyCollection<ExperimentConfiguration>>()
//                    .To(allDefinitions).CrossContext();
//        }


//        private IEnumerable<ExperimentConfiguration> CreateCustomDefinitions()
//        {
...
//            var customDefinitions = new List<ExperimentConfiguration>();
...
//        private IEnumerable<ExperimentConfiguration> CreateDefaultDefinitions(IEnumerable<ScienceExperiment> experiments)
//        {
//            if (experiments == null) throw new ArgumentNullException("experiments");
