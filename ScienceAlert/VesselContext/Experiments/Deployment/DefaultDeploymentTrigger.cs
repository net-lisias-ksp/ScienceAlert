...
namespace ScienceAlert.VesselContext.Experiments.Deployment
{
    ...
    public class DefaultDeploymentTrigger : IDeploymentTrigger
    {
        ...
        private class DefaultDeploymentTriggerBuilder :
            IConfigNodeObjectGraphBuilder<IDeploymentTrigger>
        {
            ...
            public IDeploymentTrigger Build(IConfigNodeObjectGraphBuilder<IDeploymentTrigger> builder, ConfigNode config)
            {
                return Build(config);
            }
