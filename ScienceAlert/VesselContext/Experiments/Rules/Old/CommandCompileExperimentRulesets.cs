...
//            var combinedRules = new List<RuleDefinitionSet>(definedRulesets.Union(defaultRulesets));
...
//                injectionBinder.Bind<RuleDefinitionSet>().ToValue(ruleset).ToName(ruleset.Experiment).CrossContext();

//            injectionBinder.Bind<IEnumerable<RuleDefinitionSet>>().ToValue(combinedRules).CrossContext();
//        }


//        private IList<RuleDefinitionSet> CompileRulesetsFromConfigNodes()
//        {
//            var rulesets = new List<RuleDefinitionSet>();
...
//        private IList<RuleDefinitionSet> CompileDefaultRulesetsForRemainingExperiments(
//            IEnumerable<ScienceExperiment> experimentsWithRules)
//        {
//            return
//                _experiments.Except(experimentsWithRules)
//                    .Select(se => new RuleDefinitionSet(se, _defaultOnboardRule.Value, _defaultAvailabilityRule.Value)).ToList();
//        }


//        private Maybe<RuleDefinitionSet> CompileRuleset(ConfigNode ruleConfig)
//        {
//            try
//            {
...
//                    return Maybe<RuleDefinitionSet>.None;
//                }
...
//                return new RuleDefinitionSet(forExperiment.Value, onboardDefinition, availabilityDefinition).ToMaybe();
//            }
//            catch (Exception e)
//            {
